...
> [!CAUTION]
> ⚠️ **Common Mistake:** Deleting a VM by default also deletes its boot disk unless you explicitly set “Keep disk” / uncheck auto-delete on that disk. This trips people up when trying to preserve data by just stopping/deleting an instance.
