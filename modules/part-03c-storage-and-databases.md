...
> [!CAUTION]
> ⚠️ **Common Mistake:** Bigtable is not a good fit for small datasets (<1TB) or low-throughput use cases — it needs scale to justify its operational model. A common wrong-answer distractor is picking Bigtable for a “simple mobile app backend” (Firestore is correct there).
